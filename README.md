...
* Display book details (cover image, description, authors, published date, etc.).

* Add books to your personal “shelf”.

* A “quest” mode / theme (optional or conceptual) where the user is encouraged to explore new genres, authors or themes.
